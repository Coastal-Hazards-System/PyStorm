...
(``backend/python/peaks_over_threshold/``) per CyHAN v2.1 §16.2 / §16.5.
...
PYTHON_PKG_DIR = (HERE / ".." / ".." / "python" / "peaks_over_threshold").resolve()

MODULE_NAME = "_pot"
SOURCE_FILE = HERE / "pot_bindings.cpp"
...
def _build_direct() -> None:
    ...
    BUILD_DIR.mkdir(exist_ok=True)
    obj_file = BUILD_DIR / "pot_bindings.o"
